...
cmake -G "Ninja" ^
    ...
    -DCMAKE_EXE_LINKER_FLAGS="-static-libgcc -static-libstdc++ -static -mconsole -L%OPENSSL_LIB_DIR% -lws2_32 -lcrypt32 -ladvapi32 -lmingw32 -lmingwex" ^
...
for %%m in (%MODULES%) do (
    if /I not "%%m"=="qtbase" (
        ...
        cmake -G "Ninja" ^
            ...
            -DOPENSSL_CRYPTO_LIBRARY="%OPENSSL_LIB_DIR%\libcrypto.a" ^
            -DOPENSSL_SSL_LIBRARY="%OPENSSL_LIB_DIR%\libssl.a" ^
            -DCMAKE_EXE_LINKER_FLAGS="-static-libgcc -static-libstdc++ -static -mconsole -L%OPENSSL_LIB_DIR% -lmingw32 -lmingwex" ^
